...
export default function QuantumMindsLandingPage() {
  ...
  useEffect(() => {
    ...
    const createParticles = () => {
      ...
      const density = Math.max(1, Math.floor(canvas.width / 300))
                ...
                {Object.entries(sections).map(([key, section], index) => (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <motion.div
                        animate={{
                          rotate: activeSection === key ? [0, 15, -15, 0] : 0,
                          scale: activeSection === key ? [1, 1.2, 1] : 1,
                        }}
                        transition={{
                          duration: 0.5,
                          repeat: activeSection === key ? 0 : 0,
                          repeatType: "loop",
                        }}
                      >
                        {section.icon}
